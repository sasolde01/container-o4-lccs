...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-o4-lccs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-o4-lccs.containers.anotherwebservice.com/
...
```
git clone git@github.com:sasolde01/container-o4-lccs.git
cd container-o4-lccs
```
...
```
docker attach container-o4-lccs
```
